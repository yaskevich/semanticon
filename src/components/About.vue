<template>
  <div class="home p-component">
    ...
    <div v-for="(person, index) in persons" :key="index" :class="'p-d-flex p-ai-end p-mt-4  p-flex-column p-flex-md-row person back-'+(index%2+1)">
      <div class="p-pb-4"><img :src="'/api/media/' + person[3]" style="max-height:15rem;margin-top:-4rem;text-align:left;"/></div>
...
export default {
  ...
  setup(){
    const persons = [
      ["Екатерина Владимировна Рахилина", "д. ф. н., профессор, руководитель Школы Лингвистики НИУ ВШЭ", "руководитель проекта", "people_rakhilina.jpg"],
      ["Светлана Пужаева", "аспирантка Школы Лингвистики НИУ ВШЭ", "составление, классификация и разметка исходного списка; исследование диахронии", "people_puzhaeva.jpg"],
      ["Полина Бычкова", "аспирантка Школы Лингвистики НИУ ВШЭ", "разработка структуры базы, типологическое исследование формул", "people_bychkova.jpg"],
      ["Евгения Слепак", "студентка магистратуры «Русский язык как иностранный», НИУ ВШЭ", "исследование интонации и жестикуляции, разметка", "people_slepak.jpg"],
      ["Евгения Козюк", "аспирантка Школы Лингвистики НИУ ВШЭ", "поиск переводных аналогов в английском, типологическое исследование формул, исследование связи формул и конструкций", "people_koziuk.jpg"],
      ["Татьяна Зотова", "к. ф. н., преподаватель Школы иностранных языков НИУ ВШЭ", "поиск переводных аналогов в немецком", "people_zotova.jpg"],
      ["Алевтина Уткина", "студентка магистратуры «Лингвистическая теория и описание языка», НИУ ВШЭ", "разметка, поиск переводных аналогов в китайском", "people_utkina.jpeg"],
    ];
    const defs = [
      ["Поиск"],
