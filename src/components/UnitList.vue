<template>
  <div class="p-component">
    ...
    <!-- {{value}} -->
    <div v-if="data.units[value[0]]['phrase'].length != 1">Варианты:
        ...
        <!-- {{value}} -->
        <Unit v-for="(uid, index) in value" :key="index" :uid="uid" :num="value.length>1?String(index+1):''" :data="data"
        :last="value.length-1==index" :unit="data.units[uid]" :auth="isAuth()"/>
